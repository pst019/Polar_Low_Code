...
plt.title('ASR crit 7 - 10th percentile')
PlotTRACK_PL(TPL, t, map, track=True, nowPL=False)
#PlotTRACK_PL(TPL, t, map, track=True, nowPL=False)


"""ASR - wind and surface pressure - for new PLs"""
TPL5=TRACK_PLlist_Year(year, name='6', model='ASR')
TPL5.PLlist= TPL5.PLlist[2:, TPL5.PLlist[1]== month]
...
plt.title('ASR crit 6 - 5th percentile')
PlotTRACK_PL(TPL5, t, map, track=True, nowPL=False)
#PlotTRACK_PL(TPL, t, map, track=True, nowPL=False)
...
TPLera4=TRACK_PLlist_2(year, month, name='6_2')
#TPLera6=TRACK_PLlist_2(year, month, name='6')
...
plt.title('ERA crit 7 - 10th percentile 3 crit')
...
plt.title('ERA crit 6_2 - 5th percentile 6 crit')

PlotTRACK_PL(TPLera4, t//2, map, track=True, nowPL=False) #, color= 'orange')
...
#PlotContours(Lon, Lat, de.MSLP[0], map, nrlevels= 20)
#
#plt.title('ERA new 6 crit')
#PlotTRACK_PL(TPLera6, t//2, map, track=True, nowPL=False) #, color= 'yellow')
#
##
