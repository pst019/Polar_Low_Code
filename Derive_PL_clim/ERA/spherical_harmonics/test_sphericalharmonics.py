...
#
## grid, time step info
#nlons = len(d.lon)  # number of longitudes
#ntrunc = int(nlons/4)  # spectral truncation (for alias-free computations)
#nlats = len(d.lat)   # for gaussian grid.
##dt = 150 # time step in seconds
##itmax = int(86400/dt) # 6 # integration length in days
#
## parameters for test
...
#x= shtns.sht(ntrunc, ntrunc, 1, shtns.sht_orthonormal+shtns.SHT_NO_CS_PHASE)
#a= x.set_grid(nlats,nlons,shtns.sht_quick_init|shtns.SHT_PHI_CONTIGUOUS,1.e-10)
#
