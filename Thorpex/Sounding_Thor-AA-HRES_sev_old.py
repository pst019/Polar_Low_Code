...
"""HRES specification"""
HRES_name="oper_PL_20080303_00_12_vertical.nc"
...
plt.plot(Thorthetaavg, plevels, 'black', label='Thorpex')
...
plt.plot(np.average(thorRH, axis= 0), plevels, 'black', label='Thorpex')
...
plt.plot(np.average(thorU, axis= 0), plevels, 'black', label='Thor')
