...
distance= 200 #radius of the green circle
...
if setup== 'shear':
    ...
    #calculate the shear        
    u_mean= value_in_rad(ds['u'].mean(dim='plev'), ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance)
    v_mean= value_in_rad(ds['v'].mean(dim='plev'), ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance)
    print('mean wind:', u_mean, v_mean)
          
    u_therm_m= value_in_rad(u_therm, ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance, intype='np')
    v_therm_m= value_in_rad(v_therm, ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance, intype='np')    
...
localmax= value_in_rad(ds[var], ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance, type='max')
localmin= value_in_rad(ds[var], ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance, type='min')
localmean= value_in_rad(ds[var], ds.lat, ds.lon, S_now.lat.values[0], S_now.lon.values[0], distance= distance, type='mean')
