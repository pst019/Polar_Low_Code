...
if var_evol_cont3_full == 'blh': cont_levels3 = np.arange(0, 1501, 50) 
...
if imp_list:
    ...
    file= Mediadir + "ERA5_STARS/PL_centred_fields/" +var_evol + '_'+ str(plevel) + '_allObs.nc'
...
#    plt.clabel(cs2, cont_levels2[::2], fontsize=10, fmt='%1.0f')#, inline=1)
...
if save:
    save_name=savedir+ 'SOM_'+var_full+"_"+str(plevel)+"_"+Obs+'--mean_'+var_evol_full+"_"+var_evol_cont_p_full +"_"+var_evol_cont2_p_full+"_"+var_evol_cont3_full+'_'+Obs_evol_str+"_x"+str(x)+"_y"+str(y)
    print(save_name)
    plt.savefig(save_name , bbox_inches='tight')
