...
print('plot the SOMs')
fig= plt.figure(fignr, figsize= (9,4.5) )
...
#        ax1.text(-1, -6.5+ iplev*3.5, str(plevel)+' hPa',  horizontalalignment='right', verticalalignment='center')
    ...
    if iSOM in [1,6]:
        a=['10m', '925 hPa', '850 hPa', 'Propag.', '700 hPa', '500 hPa']
...
#    
#
fig.text(0.5, 0.01, r"Horizontal speed in propagation direction [m$\cdot$s$^{-1}$]", ha='center')
fig.text(0.92, 0.5, 'Horizontal speed perp. to propag. [m$\cdot$s$^{-1}$]', va='center', rotation='vertical')
