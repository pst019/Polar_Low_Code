...
in_dir  <- "/media/pst019/1692A00D929FEF8B/ERA5_STARS/data/"
f_name  <- "surface_era5_1999_12_19_eag.nc"
setwd(out_dir)
...
K_SOM <- som(X=data.matrix(mslp), grid = somgrid(nx, ny, "hex"), rlen=100, alpha = c(0.05,0.01), radius = c(5,1), keep.data=T)
print("FIN")
