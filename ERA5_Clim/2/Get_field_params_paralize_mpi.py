...
def calc_param_to_list(time_steps, tracks= tracks, param= param, param_var= param_var, param_type= param_type, workdir= workdir):
    param_list= dict()
...
# x_s= np.empty(nx_r)
# if rank== 0:
# comm.Scatter(time_steps, x_s, root= 0)
